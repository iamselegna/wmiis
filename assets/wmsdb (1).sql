...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 21, 2020 at 03:01 PM
...
(2, '871-0253', 80, '2020-02-20 00:00:00'),
(3, '871-0284', 60, '2020-02-20 00:00:00'),
...
INSERT INTO `spm_inbound_inventory` (`InboundId`, `ArNo`, `DateIn`) VALUES
(1, '874512', '2020-01-14 00:00:00'),
(2, '896512', '2020-01-14 00:00:00'),
(3, '987451', '2020-01-14 00:00:00'),
(4, '985614', '2020-01-14 00:00:00'),
(5, '123456', '2020-01-14 00:00:00'),
(6, '654785', '2020-01-14 00:00:00'),
(7, '147852', '2020-01-14 00:00:00'),
(8, '547842', '2020-01-15 00:00:00'),
(9, '965475', '2020-01-21 00:00:00'),
(10, '999999', '2020-01-22 00:00:00'),
(11, '754861', '2020-01-27 00:00:00'),
(12, '8745146', '2020-01-29 00:00:00'),
(13, '7541246', '2020-01-29 00:00:00'),
(14, '896541', '2020-02-01 00:00:00'),
(15, '874512', '2020-02-03 00:00:00'),
(16, '745842', '2020-02-03 00:00:00'),
(17, '845974', '2020-02-03 00:00:00'),
(18, '978454', '2020-02-03 00:00:00'),
(19, '879546', '2020-02-03 00:00:00'),
(20, '879548', '2020-02-03 00:00:00'),
(21, '896548', '2020-02-03 00:00:00'),
(22, '895468', '2020-02-03 00:00:00'),
(23, '798545', '2020-02-04 00:00:00'),
(24, '1235459', '2020-02-21 00:00:00');
...
--
-- AUTO_INCREMENT for table `spm_inbound_inventory`
--
ALTER TABLE `spm_inbound_inventory`
  MODIFY `InboundId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT for table `spm_inbound_inventory_item`
--
ALTER TABLE `spm_inbound_inventory_item`
  MODIFY `InboundItemId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `spm_inbound_inventory_item`
  ADD CONSTRAINT `InboundId` FOREIGN KEY (`InboundId`) REFERENCES `spm_inbound_inventory` (`InboundId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
